...
ALLOWED_HOSTS = [
    ...
    for host in os.getenv(
        "ALLOWED_HOSTS",
        "localhost,127.0.0.1,192.168.1.88",
    ).split(",")
    if host.strip()
]
...
SELF_SERVICE_ACTIVATION_TIMEOUT_SECONDS = int(
    os.getenv("SELF_SERVICE_ACTIVATION_TIMEOUT_SECONDS", "86400")
)
SELF_SERVICE_ACTIVATION_RESEND_COOLDOWN_SECONDS = int(
    os.getenv("SELF_SERVICE_ACTIVATION_RESEND_COOLDOWN_SECONDS", "60")
)
SELF_SERVICE_REGISTRATION_COOLDOWN_SECONDS = int(
    os.getenv("SELF_SERVICE_REGISTRATION_COOLDOWN_SECONDS", "60")
)
